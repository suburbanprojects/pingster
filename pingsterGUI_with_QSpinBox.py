...
from PyQt6.QtWidgets import (QWidget, QLabel, QLineEdit, QGridLayout,
                            QApplication, QPushButton, QTextEdit, QSpinBox)
...
class PingThread(QThread):
    ...
    def run(self):
        ...
        process = subprocess.run(["ping", parameter, str(self.count), self.host], capture_output=True, text=True)
...
class Pingster(QWidget):
    ...
    def initUI(self):
        ...
        self.PingCount = QSpinBox()
        self.PingCount.setMinimum(1)
        self.PingCount.setMaximum(20)
